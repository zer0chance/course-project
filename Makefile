...
TEST = bin/test.exe
TEST_DEPENDENCIES = build/test/main.o build/test/sort_price.o build/test/sort_relevance.o build/test/difference_gb.o build/test/difference_min.o build/test/difference_sms.o build/test/gb_for_me.o build/test/min_for_me.o build/test/sms_for_me.o build/test/quantity.o build/test/bool_for_me.o
...
build/test/quantity.o: src/quantity.cpp src/tarif.h 
	$(CC) $(TEST_CFLAGS) src/quantity.cpp -o build/test/quantity.o

build/test/bool_for_me.o: src/bool_for_me.cpp src/tarif.h 
	$(CC) $(TEST_CFLAGS) src/bool_for_me.cpp -o build/test/bool_for_me.o
