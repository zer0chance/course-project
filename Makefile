...
TEST = bin/test.exe
TEST_DEPENDENCIES = build/test/main.o build/test/sort_price.o build/test/sort_relevance.o build/test/difference_gb.o build/test/difference_min.o build/test/difference_sms.o build/test/gb_for_me.o build/test/min_for_me.o build/test/sms_for_me.o build/test/quantity.o 
